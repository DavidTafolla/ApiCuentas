...
import com.api.hateoas.exceptions.CuentaNotFoundExceptions;
...
public class CuentaService {
    ...
    public void delete(Integer id) throws CuentaNotFoundExceptions {
        if (!cuentaRepository.existsById(id)){
            throw new CuentaNotFoundExceptions("Cuenta no encontrada con el ID:" + id);
        }
